/**
 * Возвращает случайный вопрос по заданной теме.
 * @param {string} topic - Тема вопроса (html, css, javascript, react, random).
 * @returns {{ question: object, questionTopic: string }} Объект с вопросом и темой.
 */
